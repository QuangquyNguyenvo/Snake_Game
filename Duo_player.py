def duo_mode(game_state, snakes_speed):    
    ...
    def screen_restart(player_win):
        ...
        font_noitce = pygame.font.Font(None, 40)
        screen.fill(BLACK)
        ...
        if player_win == 0:
            ...
            if point_player2 > point_player1:
                player_win = 2
        if player_win != 0:
            text_restart = font_restart.render("Player " + str(player_win) + " win! Press 'r' to play again", True, WHITE)
        else:
            text_restart = font_noitce.render("The game ended in a tie! Press 'r' to play again", True, WHITE)
